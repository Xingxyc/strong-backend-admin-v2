package com.strong.boot.module.bpm.convert.task;

import com.strong.boot.framework.common.pojo.PageResult;
import com.strong.boot.framework.common.util.number.NumberUtils;
import com.strong.boot.module.bpm.controller.admin.task.vo.instance.BpmProcessInstancePageItemRespVO;
import com.strong.boot.module.bpm.controller.admin.task.vo.instance.BpmProcessInstanceRespVO;
import com.strong.boot.module.bpm.dal.dataobject.definition.BpmProcessDefinitionExtDO;
import com.strong.boot.module.bpm.dal.dataobject.task.BpmProcessInstanceExtDO;
import com.strong.boot.module.bpm.framework.bpm.core.event.BpmProcessInstanceResultEvent;
import com.strong.boot.module.bpm.service.message.dto.BpmMessageSendWhenProcessInstanceApproveReqDTO;
import com.strong.boot.module.bpm.service.message.dto.BpmMessageSendWhenProcessInstanceRejectReqDTO;
