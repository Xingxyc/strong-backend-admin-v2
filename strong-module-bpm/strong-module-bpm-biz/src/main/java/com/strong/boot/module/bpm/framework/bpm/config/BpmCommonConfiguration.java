package com.strong.boot.module.bpm.framework.bpm.config;

import com.strong.boot.module.bpm.framework.bpm.core.event.BpmProcessInstanceResultEventPublisher;
