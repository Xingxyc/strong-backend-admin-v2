package com.strong.boot.module.bpm.service.definition;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.ObjectUtil;
import cn.hutool.core.util.StrUtil;
import com.strong.boot.framework.common.enums.CommonStatusEnum;
import com.strong.boot.framework.common.util.collection.CollectionUtils;
import com.strong.boot.framework.common.util.object.ObjectUtils;
import com.strong.boot.framework.datapermission.core.annotation.DataPermission;
import com.strong.boot.framework.flowable.core.util.FlowableUtils;
import com.strong.boot.module.bpm.controller.admin.definition.vo.rule.BpmTaskAssignRuleCreateReqVO;
import com.strong.boot.module.bpm.controller.admin.definition.vo.rule.BpmTaskAssignRuleRespVO;
import com.strong.boot.module.bpm.controller.admin.definition.vo.rule.BpmTaskAssignRuleUpdateReqVO;
import com.strong.boot.module.bpm.convert.definition.BpmTaskAssignRuleConvert;
import com.strong.boot.module.bpm.dal.dataobject.definition.BpmTaskAssignRuleDO;
import com.strong.boot.module.bpm.dal.dataobject.definition.BpmUserGroupDO;
import com.strong.boot.module.bpm.dal.mysql.definition.BpmTaskAssignRuleMapper;
import com.strong.boot.module.bpm.enums.DictTypeConstants;
import com.strong.boot.module.bpm.enums.definition.BpmTaskAssignRuleTypeEnum;
import com.strong.boot.module.bpm.framework.flowable.core.behavior.script.BpmTaskAssignScript;
import com.strong.boot.module.system.api.dept.DeptApi;
import com.strong.boot.module.system.api.dept.PostApi;
import com.strong.boot.module.system.api.dept.dto.DeptRespDTO;
...
import com.strong.boot.module.system.api.permission.RoleApi;
import com.strong.boot.module.system.api.user.AdminUserApi;
import com.strong.boot.module.system.api.user.dto.AdminUserRespDTO;
...
import static com.strong.boot.framework.common.util.collection.CollectionUtils.convertMap;
import static com.strong.boot.framework.common.util.collection.CollectionUtils.convertSet;
import static com.strong.boot.framework.common.util.json.JsonUtils.toJsonString;
import static com.strong.boot.module.bpm.enums.ErrorCodeConstants.*;
