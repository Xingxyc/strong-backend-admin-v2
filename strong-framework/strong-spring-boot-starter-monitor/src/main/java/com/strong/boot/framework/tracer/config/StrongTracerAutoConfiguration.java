package com.strong.boot.framework.tracer.config;

import com.strong.boot.framework.common.enums.WebFilterOrderEnum;
import com.strong.boot.framework.tracer.core.aop.BizTraceAspect;
import com.strong.boot.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "strong.tracer", value = "enable", matchIfMissing = true)
public class StrongTracerAutoConfiguration {
