 ...
 */
@AutoConfiguration
// 允许使用 strong.websocket.enable=false 禁用websocket
@ConditionalOnProperty(prefix = "strong.websocket", value = "enable", matchIfMissing = true)
@EnableConfigurationProperties(WebSocketProperties.class)
public class StrongWebSocketAutoConfiguration {
    @Bean
