package com.strong.boot.framework.websocket.core;
...
public class StrongWebSocketHandlerDecorator extends WebSocketHandlerDecorator {
    public StrongWebSocketHandlerDecorator(WebSocketHandler delegate) {
        super(delegate);
    }
