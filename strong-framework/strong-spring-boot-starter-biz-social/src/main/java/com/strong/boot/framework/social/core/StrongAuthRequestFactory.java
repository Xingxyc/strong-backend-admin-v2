package com.strong.boot.framework.social.core;

import cn.hutool.core.util.EnumUtil;
import cn.hutool.core.util.ReflectUtil;
import com.strong.boot.framework.social.core.enums.AuthExtendSource;
import com.strong.boot.framework.social.core.request.AuthWeChatMiniAppRequest;
 ...
 * @date 2021-10-31
 */
public class StrongAuthRequestFactory extends AuthRequestFactory {
    ...
    public StrongAuthRequestFactory(JustAuthProperties properties, AuthStateCache authStateCache) {
