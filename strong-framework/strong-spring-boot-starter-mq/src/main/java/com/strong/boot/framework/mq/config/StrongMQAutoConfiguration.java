package com.strong.boot.framework.mq.config;

import cn.hutool.core.map.MapUtil;
import cn.hutool.core.util.StrUtil;
import cn.hutool.system.SystemUtil;
import com.strong.boot.framework.common.enums.DocumentEnum;
import com.strong.boot.framework.mq.core.RedisMQTemplate;
import com.strong.boot.framework.mq.core.interceptor.RedisMessageInterceptor;
import com.strong.boot.framework.mq.core.pubsub.AbstractChannelMessageListener;
import com.strong.boot.framework.mq.core.stream.AbstractStreamMessageListener;
import com.strong.boot.framework.mq.job.RedisPendingMessageResendJob;
...
public class StrongMQAutoConfiguration {
    ...
    @ConditionalOnProperty(prefix = "strong.mq.redis.pubsub", value = "enable", matchIfMissing = true) // 允许使用 strong.mq.redis.pubsub.enable=false 禁用多租户
    ...
    @ConditionalOnProperty(prefix = "strong.mq.redis.stream", value = "enable", matchIfMissing = true) // 允许使用 strong.mq.redis.stream.enable=false 禁用多租户
