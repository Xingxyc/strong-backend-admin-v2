package com.strong.boot.framework.operatelog.core.aop;
...
import com.strong.boot.framework.operatelog.core.service.OperateLog;
import com.strong.boot.framework.operatelog.core.service.OperateLogFrameworkService;
import com.strong.boot.framework.web.core.util.WebFrameworkUtils;
...
import static com.strong.boot.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
...
public class OperateLogAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint, Operation operation) throws Throwable {
        ...
        com.strong.boot.framework.operatelog.core.annotations.OperateLog operateLog = getMethodAnnotation(joinPoint,
                com.strong.boot.framework.operatelog.core.annotations.OperateLog.class);
    ...
    public Object around(ProceedingJoinPoint joinPoint,
                         com.strong.boot.framework.operatelog.core.annotations.OperateLog operateLog) throws Throwable {
        return around0(joinPoint, operateLog, null);
    }

    private Object around0(ProceedingJoinPoint joinPoint,
                           com.strong.boot.framework.operatelog.core.annotations.OperateLog operateLog,
