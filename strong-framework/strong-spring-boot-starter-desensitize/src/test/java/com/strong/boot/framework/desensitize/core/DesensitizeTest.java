package com.strong.boot.framework.desensitize.core;

import com.strong.boot.framework.common.util.json.JsonUtils;
import com.strong.boot.framework.desensitize.core.regex.annotation.EmailDesensitize;
import com.strong.boot.framework.desensitize.core.regex.annotation.RegexDesensitize;
import com.strong.boot.framework.desensitize.core.annotation.Address;
import com.strong.boot.framework.desensitize.core.slider.annotation.BankCardDesensitize;
import com.strong.boot.framework.desensitize.core.slider.annotation.CarLicenseDesensitize;
import com.strong.boot.framework.desensitize.core.slider.annotation.ChineseNameDesensitize;
import com.strong.boot.framework.desensitize.core.slider.annotation.FixedPhoneDesensitize;
import com.strong.boot.framework.desensitize.core.slider.annotation.IdCardDesensitize;
import com.strong.boot.framework.desensitize.core.slider.annotation.PasswordDesensitize;
import com.strong.boot.framework.desensitize.core.slider.annotation.MobileDesensitize;
import com.strong.boot.framework.desensitize.core.slider.annotation.SliderDesensitize;
