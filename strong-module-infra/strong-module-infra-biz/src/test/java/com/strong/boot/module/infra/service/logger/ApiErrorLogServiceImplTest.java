package com.strong.boot.module.infra.service.logger;
...
import com.strong.boot.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogExportReqVO;
import com.strong.boot.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import com.strong.boot.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import com.strong.boot.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.strong.boot.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.strong.boot.framework.test.core.util.RandomUtils.randomLongId;
import static com.strong.boot.framework.test.core.util.RandomUtils.randomPojo;
import static com.strong.boot.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.strong.boot.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("strong-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("strong-test");
