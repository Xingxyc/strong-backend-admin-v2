package com.strong.boot.module.infra.service.codegen.inner;
...
import com.strong.boot.framework.common.exception.util.ServiceExceptionUtil;
...
import com.strong.boot.framework.common.util.date.LocalDateTimeUtils;
...
import com.strong.boot.module.infra.enums.codegen.CodegenFrontTypeEnum;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "strong-module-${table.moduleName}/" + // 顶级模块
                "strong-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "strong-module-${table.moduleName}/" + // 顶级模块
                "strong-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "strong-ui-${sceneEnum.basePackage}/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "strong-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
