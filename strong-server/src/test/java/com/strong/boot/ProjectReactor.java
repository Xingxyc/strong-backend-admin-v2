...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.strong.boot";
    private static final String ARTIFACT_ID = "strong";
    private static final String PACKAGE_NAME = "com.strong.boot";
    private static final String TITLE = "思创管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.strong.boot";
        String artifactIdNew = "strong";
        String packageNameNew = "com.strong.boot";
        String titleNew = "思创管理系统";
        //String projectBaseDirNew = projectBaseDir + "-new"; // 一键改名后，“新”项目所在的目录
        String projectBaseDirNew = "/Users/xingyichuan/devTools/a_backend/strong/strong-backend-admin"; // 一键改名后，“新”项目所在的目录
