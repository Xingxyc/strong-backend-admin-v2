package com.strong.boot.module.system.controller.admin.sms.vo.template;
...
public class SmsTemplateBaseVO {
    ...
    @Schema(description = "模板名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "strong")
