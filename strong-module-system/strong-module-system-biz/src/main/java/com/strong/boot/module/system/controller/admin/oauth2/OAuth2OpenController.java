...
import com.strong.boot.framework.common.util.http.HttpUtils;
import com.strong.boot.framework.common.util.json.JsonUtils;
...
import com.strong.boot.module.system.convert.oauth2.OAuth2OpenConvert;
...
import com.strong.boot.module.system.util.oauth2.OAuth2Utils;
...
import static com.strong.boot.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static com.strong.boot.framework.common.exception.util.ServiceExceptionUtil.exception0;
import static com.strong.boot.framework.common.pojo.CommonResult.success;
import static com.strong.boot.framework.common.util.collection.CollectionUtils.convertList;
import static com.strong.boot.framework.security.core.util.SecurityFrameworkUtils.getLoginUserId;
