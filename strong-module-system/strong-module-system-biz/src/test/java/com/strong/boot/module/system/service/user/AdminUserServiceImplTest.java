package com.strong.boot.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import com.strong.boot.framework.common.enums.CommonStatusEnum;
import com.strong.boot.framework.common.exception.ServiceException;
import com.strong.boot.framework.common.pojo.PageResult;
import com.strong.boot.framework.common.util.collection.ArrayUtils;
...
import com.strong.boot.module.infra.api.file.FileApi;
import com.strong.boot.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import com.strong.boot.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import com.strong.boot.module.system.controller.admin.user.vo.user.*;
import com.strong.boot.module.system.dal.dataobject.dept.DeptDO;
import com.strong.boot.module.system.dal.dataobject.dept.PostDO;
import com.strong.boot.module.system.dal.dataobject.dept.UserPostDO;
import com.strong.boot.module.system.dal.dataobject.user.AdminUserDO;
import com.strong.boot.module.system.dal.mysql.dept.UserPostMapper;
import com.strong.boot.module.system.dal.mysql.user.AdminUserMapper;
import com.strong.boot.module.system.enums.common.SexEnum;
import com.strong.boot.module.system.service.dept.DeptService;
import com.strong.boot.module.system.service.dept.PostService;
import com.strong.boot.module.system.service.permission.PermissionService;
...
import static com.strong.boot.framework.common.util.collection.SetUtils.asSet;
import static com.strong.boot.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.strong.boot.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static com.strong.boot.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static com.strong.boot.framework.test.core.util.AssertUtils.assertPojoEquals;
import static com.strong.boot.framework.test.core.util.AssertUtils.assertServiceException;
import static com.strong.boot.framework.test.core.util.RandomUtils.*;
import static com.strong.boot.module.system.enums.ErrorCodeConstants.*;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("strongyuanma");
        ...
        assertEquals("strongyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("strongyuanma"))).thenReturn("java");
